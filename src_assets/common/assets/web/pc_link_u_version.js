class PCLinkUVersion {
  ...
  isGreater(otherVersion, checkIncremental) {
    ...
    if (otherVersion instanceof PCLinkUVersion) {
      ...
      throw new Error('Invalid argument: otherVersion must be a PCLinkUVersion object or a version string');
    }
